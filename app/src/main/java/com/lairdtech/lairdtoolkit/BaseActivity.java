		...
		BluetoothAdapterHelperCallback
{
	...
	ListFoundDevicesHandler mListFoundDevicesHandler = null;
	...
	protected boolean isPrefPeriodicalScan = false;
	...
	protected void initialiseDialogFoundDevices(String title)
	{
		 ...
		 */
		ListView mLvFoundDevices = (ListView)this.findViewById(R.id.bleList);
		...
		mLvFoundDevices.setOnItemClickListener(new OnItemClickListener()
		{
					...
					int position, long id)
			{
				...
				//once clicked to connect, do not want be able to click again
				mListFoundDevicesHandler.setDeviceClickEnable(position, false);
			}
		});
	}
